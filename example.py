...
twitch_miner = TwitchChannelPointsMiner(
    username="one_lio",
    password="LioF@01042011",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=-1003770581491,                                                      # Chat ID to send messages @getmyid_bot
            token="8369214340:AAG_YKx4AL3_bM2VPsxfGTiVFNHk2pV7hKU",                          # Telegram API token @BotFather
